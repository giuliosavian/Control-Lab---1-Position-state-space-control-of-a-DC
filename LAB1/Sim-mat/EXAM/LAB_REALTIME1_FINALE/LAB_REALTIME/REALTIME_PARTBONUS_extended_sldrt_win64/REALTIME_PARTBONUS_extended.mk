...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2020b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := REALTIME_PARTBONUS_extended
MODULES              := REALTIME_PARTBONUS_extended_data.c REALTIME_PARTBONUS_extended_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := REALTIME_PARTBONUS_extended.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2020b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := REALTIME_PARTBONUS_extended_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/LAB_REALTIME;Z:/windows_profile/Desktop/LAB_REALTIME/REALTIME_PARTBONUS_extended_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
REQ_DEFINES := -DUSE_RTMODEL -DMODEL=$(MODEL) -DRT -DNUMST=$(NUMST) \
               ...
               -DMT=$(MULTITASKING) $(DEFINES_CUSTOM) $(DEFINES_OTHER)
