...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&REALTIME_PART2_robust_B.thl_ref), 0, 0, 8 }
  ,

  { (char_T *)(&REALTIME_PART2_robust_DW.EncoderInput_PWORK), 11, 0, 7 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&REALTIME_PART2_robust_P.ctrl), 14, 0, 1 },

  { (char_T *)(&REALTIME_PART2_robust_P.sens), 19, 0, 1 },

  { (char_T *)(&REALTIME_PART2_robust_P.Ki), 0, 0, 15 },

  { (char_T *)(&REALTIME_PART2_robust_P.EncoderInput_Channels), 6, 0, 4 },

  { (char_T *)(&REALTIME_PART2_robust_P.Step_Time), 0, 0, 12 }
};
...
/* [EOF] REALTIME_PART2_robust_dt.h */
